  ...
  return (
    <div className="space-y-6">
      <section className="rounded-[28px] border border-[#ddd6cc] bg-white p-6 shadow-[0_10px_35px_rgba(30,41,59,0.06)]">
        <p className="text-[11px] font-semibold uppercase tracking-[0.24em] text-[#94a3b8]">Tasks</p>
        <div className="mt-2 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <h1 className="text-[28px] font-semibold tracking-tight text-[#1e293b]">Tasks that need attention</h1>
            <p className="mt-2 text-[14px] text-[#64748b]">
              Keep the queue readable, claim work directly, and close tasks so the dashboard stays honest.
            </p>
          </div>
        ...
        <div className="mt-6 flex flex-wrap gap-2">
          {buckets.map((bucketOption) => {
            const href = bucketOption.key === "all" ? "/tasks" : `/tasks?bucket=${bucketOption.key}`;
